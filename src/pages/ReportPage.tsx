...
const ReportPage: React.FC = () => {
  ...
  const overallPerformance = `
    ...
    ${skills[0][1] > 7 ? 'strong' : 'developing'} foundation. You demonstrate particular strength 
    in ${strongestSkill[0]} (${strongestSkill[1]}/10), which places you above average in this area.
    Your overall communication style appears to be ${
      user.skills.communication > 6 ? 'confident and engaging' : 'thoughtful and considerate'
  ...
  const strengths = `
    ...
    Your interest in ${user.interests[0] || 'your hobbies'} also provides good conversation starters.
  `;
  
  const weaknesses = `
    One area to focus on improving is ${weakestSkill[0]} (${weakestSkill[1]}/10). 
    ${
      ...
      >
        <div className="card p-6 md:p-8">
          <div className="flex items-center mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-neutral-900">Your Dating Skills Report</h1>
              <p className="text-neutral-600">
                Based on your profile and interactions with Mirror Match
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <section>
              <h2 className="text-xl font-semibold text-neutral-900 mb-3">Overall Performance</h2>
              <p className="text-neutral-700 leading-relaxed">{overallPerformance}</p>
            </section>
            ...
            <section>
              <h2 className="flex items-center text-xl font-semibold text-neutral-900 mb-3">
                <ThumbsDown className="h-5 w-5 text-error-500 mr-2" /> Areas to Improve
              </h2>
              ...
              <div className="flex">
                ...
                <div>
                  <p className="text-neutral-800">
                    Based on your report, we recommend focusing on improving your {weakestSkill[0]} skills.
                    Chat with your coach to get personalized exercises and feedback.
                  </p>
                </div>
              </div>
            </div>
